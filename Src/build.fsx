...
let allPackageFiles = [
                        (buildDir+"EasyExecuteLib.dll");
                        (buildDir+"EasyExecute.Common.dll");
                        (buildDir+"EasyExecute.Messages.dll");
...
let product = "EasyExecute"
let authors = [ "samuel" ]
let copyright = "©2017"
let company = ""
let description = "EasyExecute"
let tags = []
let projectName="EasyExecute"
...
let testDlls = !! (buildDir + "/EasyExecute.Tests.dll")

Target "Test" (fun _ ->  
    let xunitTestAssemblies = !! (testDir + "/EasyExecute.Tests.dll")
